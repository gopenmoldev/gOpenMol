...
package ifneeded xml::c       3.0 [list load   [file join $dir libTclxml3.0.so]]
...
#
#package ifneeded xml::expat  3.0 [list load   [file join $dir @expat_TCL_LIB_FILE@]]
#package ifneeded xml::xerces 2.0       [list load   [file join $dir @xerces_TCL_LIB_FILE@]]
#package ifneeded xml::libxml2 3.0 [list load   [file join $dir @TclXML_libxml2_LIB_FILE@]]
